...
{
    [AddComponentMenu("Event/Input Module Override")]
    /// <summary>
    ...
    /// </remarks>
    public class InputModuleOverride : PointerInputModule
    {
...
//                DeselectIfSelectionChanged(currentOverGo, pointerEvent); OVERRIDE THIS LINE OF CODE
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                // DeselectIfSelectionChanged(currentOverGo, pointerEvent); OVERRIDE THIS
